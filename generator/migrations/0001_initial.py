    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Room', 'Room'), ('Lab', 'Lab'), ('Seminar Hall', 'Seminar Hall')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('FACULTY', 'Faculty'), ('HOD', 'Head of Department')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('subjects', models.ManyToManyField(to='generator.subject')),
            ],
        ),
        migrations.CreateModel(
            name='Timetable',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('faculty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generator.facultyprofile')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generator.roomlab')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generator.subject')),
                ('timeslot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generator.timeslot')),
            ],
        ),
    ]
