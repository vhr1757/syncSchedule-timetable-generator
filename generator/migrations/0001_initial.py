# Generated by Django 6.0.1 on 2026-02-14 14:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('CLASS', 'Classroom'), ('LAB', 'Lab')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generator.room')),
