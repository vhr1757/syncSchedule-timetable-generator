    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Room', 'Room'), ('Lab', 'Lab')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generator.roomlab')),
